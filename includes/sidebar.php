      ...
      <div class="sidebar">
        <div class="top">
          <div class="logo">
            <a href="index.php">
              <img
                src="/ADMIN_DTR/images/phinmasvg.svg"
                alt="Upang logo"
                class="phinmalogo"
              />
        ...
        <ul>
          ...
          <li>
            ...
            <a href="student_list.php" class="menu">Student List</a>
          </li>
          <li>
          ...
          <li>
            <i class="bx bx-news"></i>
            <a href="#" class="menu">User Management</a>
          </li>
        </ul>
        <hr class="line_2" />
        <div class="profilelinks">
          <a href="profile.php">
            <img
              src="images/profile-minus-1353-svgrepo-com.svg"
              alt="click to visit profile"
              class="profilelogo"
            />
        ...
        <div class="logout">
          <a href="#" onclick="show_logout()">
            <img
              src="/ADMIN_DTR/images/logout-svgrepo-com.svg"
              alt="click to logout"
              class="logoutlogo"
            />
